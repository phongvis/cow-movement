document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateVis() {
        ...
        googleMapOverlay.draw = function() {
            ...
            const markers = d3.select('svg').selectAll('g').data(holdingData);
            ...
            markers.merge(newMarkers).each(transform);
    ...
    function initMap() {
        ...
        const map = new google.maps.Map(mapDiv, {
            zoom: 8,
            center: new google.maps.LatLng(51.81947642808224, -2.507069743895366),
        ...
        googleMapOverlay.onAdd = function() {
            const mapRect = mapDiv.getBoundingClientRect();
            const layer = d3.select(this.getPanes().overlayLayer).append('svg')
                .style('width', mapRect.width)
                .style('height', mapRect.height);
            };
    }
